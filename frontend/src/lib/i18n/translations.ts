...
const translations = {
  en: {
    ...
    "reports.run.button": "Run pipeline now",
    "reports.run.busy": "Pipeline running…",
    "reports.run.startedAt": "Started {when}",
    "reports.run.alreadyRunning": "Another run is already in progress.",
    "reports.run.conflict":
      "A daily pipeline run is already in progress. Refresh to view its progress.",
    "reports.run.failed": "Pipeline failed. See log below.",
    "reports.run.connectionLost":
      "Connection lost. The pipeline may still be running on the server.",
    "reports.run.complete": "Pipeline complete. Reload the list to see new reports.",
    "reports.run.reload": "Reload reports",
    "reports.run.viewLogs": "View logs",
    "reports.run.hideLogs": "Hide logs",
    "reports.run.logsEmpty": "Waiting for output…",
    "reports.run.stage.ingestion": "Ingestion",
    "reports.run.stage.processing": "Processing",
    "reports.run.stage.embedding": "Embedding",
    "reports.run.stage.report": "Daily report",
  ...
  zh: {
    ...
    "reports.run.button": "立即运行流水线",
    "reports.run.busy": "流水线运行中……",
    "reports.run.startedAt": "开始于 {when}",
    "reports.run.alreadyRunning": "已有一次运行在进行中。",
    "reports.run.conflict": "已有一次流水线在运行，刷新页面可以查看进度。",
    "reports.run.failed": "流水线运行失败，详见下方日志。",
    "reports.run.connectionLost": "连接中断，但流水线可能仍在后端运行。",
    "reports.run.complete": "流水线完成，重新加载列表可以看到新简报。",
    "reports.run.reload": "重新加载简报",
    "reports.run.viewLogs": "查看日志",
    "reports.run.hideLogs": "隐藏日志",
    "reports.run.logsEmpty": "等待输出……",
    "reports.run.stage.ingestion": "数据采集",
    "reports.run.stage.processing": "摘要与评分",
    "reports.run.stage.embedding": "向量化",
    "reports.run.stage.report": "生成简报",
